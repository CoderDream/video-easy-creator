//package com.coderdream.util.ppt.demo02;
//
...
//
//  public static void PPTtoImage(String filePath, String fileName)
//    throws Exception {
...
//
//    log.info("ppt 总页数：{}， 尺寸: width={},height={}", pageSize, pgsize.width,
//      pgsize.height);
//
...
//   * @throws IOException
//   */
//  public static void pptx2Image(String filePath, String fileName)
//    throws Exception {
//
//    // 获取系统可用字体
//    GraphicsEnvironment e = GraphicsEnvironment.getLocalGraphicsEnvironment();
...
//   * @throws IOException
//   */
//  public static void ppt2Image(String filePath, String fileName)
//    throws IOException {
//    // 获取系统可用字体
//    GraphicsEnvironment e = GraphicsEnvironment.getLocalGraphicsEnvironment();
//    String[] fontNames = e.getAvailableFontFamilyNames();
...
//      new HSLFSlideShowImpl(filePath + fileName));
//
//    Dimension pgsize = ppt.getPageSize();
...
//    com.itextpdf.text.Rectangle pageSize = new com.itextpdf.text.Rectangle(0, 0,
//      width, height); // 自定义页面大小
//    Document doc = new Document(pageSize, 0, 0, 0, 0);
//    log.info(">>>>A4尺寸：width={}，height={}", pageSize.getWidth(),
//      pageSize.getHeight());
...
//    String descfolder) throws Exception {
//    String pdfPath = "";
//    try {
//      //图片操作
...
//
//      //更换图片图层
//      BufferedImage bufferedImage = new BufferedImage(img.getWidth(),
//        img.getHeight(), BufferedImage.TYPE_3BYTE_BGR);
//      bufferedImage.getGraphics()
//        .drawImage(img, 0, 0, img.getWidth(), img.getHeight(), null);
//      bufferedImage = new ColorConvertOp(
//        ColorSpace.getInstance(ColorSpace.CS_LINEAR_RGB), null).filter(
//        bufferedImage, null);
//
//      //图片流处理
//      doc.setPageSize(new com.itextpdf.text.Rectangle(bufferedImage.getWidth(),
...
//  }
//
//  public static void mergePDF(String[] files, String desfolder,
...
//    // 读入PPT文件
//    String filePath = "D:\\14_LearnEnglish\\6MinuteEnglish\\2018\\181213\\";
//    String fileName = "181213.pptx";
//
//    List<byte[]> images = pptx2Image(
...
//    FileOutputStream out = new FileOutputStream("D:\\14_LearnEnglish\\6MinuteEnglish\\2018\\181213\\docker.pdf");
