...
@Slf4j
public class MarkdownToTxtConverter1 {
  ...
  public static void main(String[] args) {
    try {
      ...
      MarkdownToTxtConverter1.convert(markdownFilePath, txtFilePath);
      System.out.println("Markdown file converted to txt file successfully!");
    } catch (IOException e) {
