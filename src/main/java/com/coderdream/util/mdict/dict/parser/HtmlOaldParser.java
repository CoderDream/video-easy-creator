...
public class HtmlOaldParser {
  ...
  public static DictOaldBean parseHtml(String htmlFilePath) {
    ...
    log.info("解析HTML文件 {} 耗时：{}， 结果: {}", htmlFilePath,
      CdDateTimeUtils.genMessage(timeElapsed), dictOaldBean);
    return dictOaldBean;
  }
  ...
  private static void parseSense(Element sense,
    List<DictOaldBean.Sense> senseList) {
...
//    DictOaldBean dictOaldBean = HtmlOaldParser.parseHtml(htmlFilePath);
//    System.out.println("from file: " + dictOaldBean);
//
//    String htmlString =
//      "<link href=\"oald.css\" rel=\"stylesheet\" type=\"text/css\">\n" +
...
//        "</div>\n" +
//        "</body>";
//    DictOaldBean dictOaldBean2 = HtmlOaldParser.parseHtmlString(htmlString);
//    System.out.println("from string: " + dictOaldBean2);
//  }

  public static DictOaldBean query(String word) {
    String htmlString = Mdict4jUtil.getHtmlString(word, CdConstants.DICT_OALD);
    return HtmlOaldParser.parseHtmlString(htmlString);
  }
}
