...
public class PdfFileFinder {
     ...
     * @return 匹配的PDF文件列表
     */
    public static List<Path> getPdfFilesWithPrefix(String directoryPath, String prefix) {
        ...
        try {
            Files.walkFileTree(dir, new SimpleFileVisitor<Path>() {
                ...
                public FileVisitResult visitFile(Path file, BasicFileAttributes attrs) throws IOException {
                    ...
                    if (file.toString().endsWith(".pdf") && file.getFileName().toString().startsWith(prefix)) {
                        pdfFiles.add(file);
                    }
