...
public class Mp4MergeUtil {
  ...
  public static void processMerge(String bookPath, String bookName) {
    // 测试示例
//    Path inputDir = Paths.get("D:/0000/EnBook002/Chapter015/video_cht");

    int count = 1;
    String inputDirStr =
      bookPath + File.separator + bookName + File.separator + "video_cht";
    Path inputDir = Paths.get(inputDirStr);
    String outputDirStr =
      bookPath + File.separator + bookName + File.separator + "video_cht_"
        + count;
    // 确保输出目录存在
...
//      count++;
//    }.
    processMerge("D:/0000/EnBook002", "Chapter016");
  }
}
