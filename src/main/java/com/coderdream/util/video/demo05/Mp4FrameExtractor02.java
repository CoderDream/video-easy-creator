...
@Slf4j
public class Mp4FrameExtractor02 {

  private static final String FFMPEG_COMMAND = "ffmpeg"; //  也可以设置为环境变量，或者可配置的参数
   ...
   */
  public static String extractFrame(String inputFilePath, String time,
    ...
    try {
      ...
      if (exitCode == 0) {
        ...
        log.info("帧提取成功: {}，耗时: {}", outputFilePath,
  ...
  public static void main(String[] args) {
    // 示例用法
    String imageAFilePath = "D:\\0000\\blueLine.png"; //  要覆盖的图片
...
//  public static void main(String[] args) {
//    String inputFilePath = "D:\\0000\\0007_Trump\\20250307\\20250307.mp4";
//    String time = "00:00:01.000"; // 要提取帧的时间点
//    String outputFilePath = "D:\\0000\\0007_Trump\\20250307\\frame_at_50s.png"; // 输出 PNG 文件路径
//
//    String extractedFrame = extractFrame(inputFilePath, time, outputFilePath);
//
//    if (extractedFrame != null) {
//      System.out.println("帧提取成功，文件保存在: " + extractedFrame);
//    } else {
//      System.out.println("帧提取失败!");
//    }
//  }
}
