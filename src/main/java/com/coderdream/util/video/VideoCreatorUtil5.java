...
@Slf4j
public class VideoCreatorUtil5 {
  ...
  private static void createVideoCore(File imageFile, File audioFile,
    ...
    command.add("pcm_s16le"); // 使用 PCM 无损音频编码（16位）
    ...
    log.info("正在执行创建视频的命令：{}", commandString);
