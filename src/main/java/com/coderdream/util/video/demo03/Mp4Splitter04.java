...
public class Mp4Splitter04 {
    ...
    public static String splitVideo(String inputFilePath, String startTime, String endTime, String outputFilePath) {
        ...
        // FFmpeg 命令，避免前2秒卡顿，使用 -ss 放在输入后，确保音画同步
        String command = String.format(
                "ffmpeg -y -i \"%s\" -ss %s -t %s -c:v libx264 -c:a aac -strict experimental -copyts \"%s\"",
                inputFilePath, startTime, duration, outputFilePath
        );
