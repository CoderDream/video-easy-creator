...
public class Mp4Splitter03 {
    ...
    public static String splitVideo(String inputFilePath, String startTime, String endTime, String outputFilePath) {
        ...
        String command = String.format(
                "ffmpeg -y -accurate_seek -ss %s -i \"%s\" -t %s -c copy \"%s\"",
    ...
    public static void main(String[] args) {
        ...
        String timeStr = "00:00:20,280 --> 00:00:25,600";
        String[] times = timeStr.split(" --> ");
        String startTime = times[0];//"00:00:03,400";
        String endTime = times[1];//"00:00:13,680";
        String outputFilePath = "D:\\0000\\0003_PressBriefings\\250128\\250128_part002.mp4";
