...
/**
 * <pre>
 *   <a href="https://learn.microsoft.com/en-us/azure/ai-services/speech-service/speech-synthesis-markup-structure#single-voice-example">Single voice example  单声部示例</a>
 *  Single voice example  单声部示例
 * </pre>
 */
public class SpeechSynthesis1002 {
