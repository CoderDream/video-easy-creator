...
/**
 * <pre>
 *   <a href="https://learn.microsoft.com/en-us/azure/ai-services/speech-service/speech-synthesis-markup-structure#single-voice-example#add-silence">添加静音</a>
 *  Add silence  添加静音
 * </pre>
 */
@Slf4j
public class SpeechSynthesis1005 {
...
//  private static String speechRegion = CdConstants.SPEECH_REGION_EAST_US;// System.getenv("SPEECH_REGION");
  ...
  public static void main(String[] args)
    ...
    SpeechConfig speechConfig = SpeechConfig.fromSubscription(CdConstants.SPEECH_KEY_EASTASIA,
