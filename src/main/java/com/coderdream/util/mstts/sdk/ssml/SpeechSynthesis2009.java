 ...
 * 更改语速示例
 * This SSML snippet illustrates how the rate attribute is
 * used to change the speaking rate to 30% greater than the default rate.
 * 此 SSML 代码段说明了如何使用 rate 属性将语速更改为比默认语速高 30%。
 * </pre>
 */
public class SpeechSynthesis2009 {
