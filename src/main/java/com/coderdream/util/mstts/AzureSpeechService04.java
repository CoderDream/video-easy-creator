...
@Slf4j
public class AzureSpeechService04 {
  ...
  public static void content2wav(List<String> textList, String voiceName,
    ...
    try (SpeechSynthesizer speechSynthesizer = new SpeechSynthesizer(
      ...
      if (result.getReason() == ResultReason.SynthesizingAudioCompleted) {
        ...
        System.out.println(
          "音频文件生成成功: " + new File(fileName).getAbsolutePath());
        stream.close();
  ...
  public static void testEn() {
    ...
    List<String> textList = List.of(
      ...
      "I agree. We should focus on interactive content, like polls and live Q&A sessions.");
    String fileName1 = "eng1234.wav";
    content2wav(textList, "en-US-JennyNeural", "default", "default", "default",
      fileName1, speechKey1, region1);
  }
...
//        testEn();
  ...
  public static void testCn() {
    List<String> textList2 = List.of(
      "这个物体的重[4]量[4]是五公斤，请重[2]复[4]一遍。"); // "这个物体的重量是五公斤，请重复一遍。";  "英文加中文配音，每次半小時，增强你的英文听力。"
    ...
    content2wav(textList2, voiceName2, "default", "default", "default",
      fileName2, speechKey2, region2);
  }
