...
@Slf4j
@Component
public class VocUtil02 {

  public static String V1 = "下面是CEFR的词汇表，每一行都包括1~3个单词，每一部分都包括单词，词性和等级，多个词性返回多行，给每个单词加上第4列，中文释义，例如单词ago，返回 adv. 以前，从前；第5列，用单词造句，最好用柯林斯词典中的例句，选稍微复杂一些的句子，记得是造句，不是给一段词组，如果柯林斯没有适合的例句，你就自己造句；第6列，整个例句的音标，不是单个单词的音标，第7列，句子的中文含义，记得把例句中的词汇单词和对应的单词中文加粗，返回格式为 Markdown 表格；返回只需要markdown中的内容，不要其他内容：";
  public static String V2 = "headword\tpos\tCEFR";

  public static void main(String[] args) {
    String fileName = "The_Oxford_3000";
