...
public class YouTubeApiUtil5 {
    ...
    public YouTubeApiUtil5() throws GeneralSecurityException, IOException {
    ...
    public static void main(String[] args) {
        try {
            YouTubeApiUtil5 youTubeApiUtil = new YouTubeApiUtil5();
            List<String> usernames = List.of("GoogleDevelopers", "wangzhian", "lingdujieshuo", "Tankman2020", "SeattleLaohu", "cnliziqi", "mkbhd", "onehour_English", "EnglishEasyPractice");
