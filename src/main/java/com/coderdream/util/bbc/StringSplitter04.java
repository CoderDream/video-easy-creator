...
public class StringSplitter04 {
  ...
  public static List<String> splitStringList(List<String> strings) {
    ...
    for (String string : strings) {
      result.addAll(StringSplitter04.splitString(string));
    }
    return result;
  }
  ...
  public static List<String> splitStringList(List<String> strings,
    ...
    List<String> result = new ArrayList<>();
    for (String string : strings) {
      result.addAll(StringSplitter04.splitString(string, maxLength));
    }
    return result;
  }
  ...
  input = "That is my job.And I will say it’s very easy to speak truth from this podium when you have a president who is implementing policies that are wildly popular with the American people,";
    ...
    int maxLength = 65;
    List<String> sentenceList = StringSplitter04.splitString(input);
    for (String string : sentenceList) {
      System.out.println(string);
    }

    sentenceList = StringSplitter04.splitStringList(sentenceList);
//
  }
}
