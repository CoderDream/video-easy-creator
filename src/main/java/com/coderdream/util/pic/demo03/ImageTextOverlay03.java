...
public class ImageTextOverlay03 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 设置字体：黑体 + 粗体，适配繁体字
//        Font mainFont = new Font("Microsoft YaHei", Font.BOLD, 100); // 第一、二行字体
//        Font bottomFont = new Font("Microsoft YaHei", Font.BOLD, 100); // 底部字体 Source Han Sans Heavy
        ...
        drawCenteredOutlinedText(g2d, mainText, image.getWidth(), 400, MAIN_TITLE_COLOR, Color.BLACK);
