...
public class ImageTextOverlay {
    ...
    private static final Color BOTTOM_SHADOW_COLOR = new Color(50, 50, 50, 80); // 底部标题阴影颜色
    ...
    public static void main(String[] args) throws IOException {
        ...
        int blueBottomTop = image.getHeight() - bottomHeight; // 蓝底顶部 y 坐标
        int blueBottomCenter = blueBottomTop + (bottomHeight / 2); // 蓝底垂直中心
        // 修正公式：使文字几何中心与蓝底中心对齐
        int centeredY = blueBottomCenter - ((ascent - descent) / 2); // 调整基线

        // 调试信息
        System.out.println("Image Height: " + image.getHeight());
        System.out.println("Blue Bottom Top: " + blueBottomTop);
        System.out.println("Blue Bottom Bottom: " + image.getHeight());
        System.out.println("Blue Bottom Center: " + blueBottomCenter);
        System.out.println("Ascent: " + ascent);
        System.out.println("Descent: " + descent);
        System.out.println("Centered Y (before adjustment): " + centeredY);
        ...
        // 微调：根据反馈，文字偏底部，向上调整 10 像素
        centeredY -= 10;

        System.out.println("Centered Y (after adjustment): " + centeredY);

        drawCentered3DOutlinedText(g2d, bottomText, image.getWidth(), centeredY, Color.WHITE, Color.BLACK);
