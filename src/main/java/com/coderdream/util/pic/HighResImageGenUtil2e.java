...
@Slf4j
public class HighResImageGenUtil2e {
    ...
    int headerHeight = 0;
      for (int i = 0; i < wordInfoList.size(); i++) {
          ...
          if (i == 0 || currentRowY + rowHeight + 10 > templateHeight - BOTTOM_MARGIN) {
              ...
              currentRowY = tableY + headerHeight + 10;  // 重置当前行Y坐标，并将数据向下偏移表头高度
  ...
  public static void main(String[] args) throws Exception {
    ...
    // 调用生成方法
    HighResImageGenUtil2e.generateImagesFromWordInfoList(wordInfoList,
      imagePath,
      fileName,
      outputDir);
  }
