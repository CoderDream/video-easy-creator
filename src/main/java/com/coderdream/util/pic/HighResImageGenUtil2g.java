...
@Slf4j
public class HighResImageGenUtil2g {
    ...
    private static final int COLUMN_WIDTH_CN = 900;
    ...
    private static final int BOTTOM_MARGIN = 130; // 底部预留空间
...
//        wordInfoList.add(new WordInfo("photography", null, "n.摄影术", "雅思", 5));
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 调用生成方法
        HighResImageGenUtil2g.generateImagesFromWordInfoList(wordInfoList,
                imagePath,
                fileName,
                outputDir);
    }
