...
@Slf4j
public class HighResImageGenUtil2d {
  ...
  private static final ColumnConfig[] columnConfigs = {
    new ColumnConfig(COLUMN_WIDTH_WORD, new Font("微软雅黑", Font.BOLD, 20),
      Color.BLACK), // 单词
    new ColumnConfig(COLUMN_WIDTH_UK, new Font("Arial Unicode MS", Font.PLAIN, 18),
      Color.DARK_GRAY), // 英音
    new ColumnConfig(COLUMN_WIDTH_CN,
      new Font("微软雅黑", Font.PLAIN, 16), Color.BLACK), // 释义
    new ColumnConfig(COLUMN_WIDTH_LEVEL, new Font("微软雅黑", Font.PLAIN, 16),
      Color.GREEN),  // 等级
    new ColumnConfig(COLUMN_WIDTH_TIMES, new Font("微软雅黑", Font.BOLD, 16),
      Color.RED)    // 次数
  };
  ...
  public static List<File> generateImagesFromWordInfoList(
    ...
    Font headerFont = new Font("微软雅黑", Font.BOLD, 36); // 统一表头字体
    int headerHeight = 0;
...
//    wordInfoList.add(new WordInfo("photography", null, "n.摄影术", "雅思", 5));
  ...
  public static void main(String[] args) throws Exception {
    ...
    // 调用生成方法
    HighResImageGenUtil2d.generateImagesFromWordInfoList(wordInfoList,
      imagePath,
      fileName,
      outputDir);
  }
