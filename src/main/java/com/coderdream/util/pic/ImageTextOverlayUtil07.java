 ...
 */
@Slf4j
public class ImageTextOverlayUtil07 {
  ...
  private static final int SUB_TITLE_Y = 180; // 0 用来标记需要自动计算，如果需要固定值，就设置具体的数值
  ...
  public static void addTextOverlay(String backgroundImagePath,
    ...
    try {
      ...
      draw3DOutlinedText(g2d, "雙語\n大字幕", image.getWidth() - 400, subTitleY,
