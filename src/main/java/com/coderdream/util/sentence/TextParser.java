...
public class TextParser {
    ...
    private static DialogSingleEntity parseLine(String englishLine, String chineseLine) {
        ...
        Matcher cnMatcher = cnPattern.matcher(chineseLine);
         ...
         if (enMatcher.find() && cnMatcher.find()) {
           ...
           dialogSingleEntity.setContentEn(PunctuationUtil.replaceChinesePunctuationToEnglish(enMatcher.group(2).trim()));
           dialogSingleEntity.setContentCn(PunctuationUtil.replaceEnglishPunctuationToChinese(cnMatcher.group(2).trim()));
    ...
    public static void main(String[] args) {
        ...
        List<List<DialogSingleEntity>> dialogList = TextParser.parseTextFile(filePath);
        if(dialogList != null){
