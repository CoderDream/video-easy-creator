...
//            return ;
        ...
        String inputDirCn =
                folderPath + subFolder + File.separator + "audio" + File.separator + "cn" + File.separator; // 替换为你的输入目录
        String inputDirEn =
                folderPath + subFolder + File.separator + "audio" + File.separator + "en" + File.separator;  // 替换为你的输入目录
        String outputFilePath =
                folderPath + subFolder + File.separator + "audio_mix" + File.separator; // 替换为你的输出文件路径
