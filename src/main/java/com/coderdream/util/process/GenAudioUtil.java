...
//    System.out.println("所有任务执行完毕，线程池已关闭！");
    ...
    String inputDirCn =
      folderPath + File.separator + subFolder + File.separator + "audio" + File.separator + "cn"
        + File.separator; // 替换为你的输入目录
    String inputDirEn =
      folderPath + File.separator + subFolder + File.separator + "audio" + File.separator + "en"
        + File.separator;  // 替换为你的输入目录
...
//    System.out.println("所有任务执行完毕，线程池已关闭！");
    ...
    String inputDirEn =
      folderPath + File.separator + subFolder + File.separator + "audio"
        + File.separator + CdConstants.LANG_EN_NORMAL
        + File.separator;  // 替换为你的输入目录
