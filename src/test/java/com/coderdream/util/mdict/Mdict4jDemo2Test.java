...
//            log.info("s:{}", word);
            try {
                ...
                HtmlContentBean htmlContentBean = Mdict4jUtil.getWordDetail(word, "collins");
                ...
                newDictionary.setReserved02(
                    ObjectUtil.isNull(htmlContentBean.getCaptions()) ? "" : htmlContentBean.getCaptions().toString());
                newDictionary.setReserved03(ObjectUtil.isNull(htmlContentBean.getSentences()) ? ""
                    : htmlContentBean.getSentences().toString());
                newDictionary.setReserved04(ObjectUtil.isNull(htmlContentBean.getTranslations()) ? ""
                    : htmlContentBean.getTranslations().toString());
                newDictionary.setReserved05(
                    ObjectUtil.isNull(htmlContentBean.getRawHtml()) ? "" : htmlContentBean.getRawHtml());
